...
(function(factory) {
     ...
     *                            setHeight - If true, sets same height of all items in a row instead.
    ...
    $.fn.positionList = function(options) {
        ...
        var setHeight = function(list){
            ...
            $.each(list, function(index, list) {
                $(o.target, list).height("auto");
                var pos = $.map(list, function(item) { return $(o.target,item).height() } );
                var max = Math.max.apply(null, pos);
                list.each(function(i) {
                    if (pos[i] !== max) {
                        $(o.target, this).height(max);
                    }
                });
            });
        ...
        return this.each(function() {
            var _this = this;
            if (o.runOnResize) {
                $(window).resize(function() { setMain(_this); });
            }
            setMain(this);
        });
    ...
    $(function() {
        ...
        $("[data-widget='position-list']").each(function() {
            var o = {
                item: $(this).data('item'),
                target: $(this).data('target'),
                setHeight: $(this).data('set-height') || false
            };
            $(this).positionList(o);
        });
