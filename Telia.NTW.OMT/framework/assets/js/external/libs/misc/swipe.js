...
/*Attention: This is changed from original script, added event for pause on mouseover. */
...
Swipe.prototype = {
  ...
  handleEvent: function(e) {
    switch (e.type) {
      case 'mouseover': this.pause(); break;
      case 'mouseleave': this.begin(); break;
  ...
  _translate: function(elem, xval, speed) {
    ...
    //style.webkitTransform = 'translate3d(' + xval + 'px,0,0)';
     style.webkitTransform = 'translate(' + xval + 'px , 0)';
    style.msTransform = 
    style.MozTransform = 
