var Chart = function(e) {
    ...
    function n(e, t, n, r) {
        function i() {
            ...
            1 >= a ? y(i) : "function" == typeof e.onAnimationComplete && e.onAnimationComplete();
        }
    ...
    function i(e, t, n, r, i) {
        if (e) for (var s = 1; s < n + 1; s++) t.push(u(e, {
    ...
    function u(e, t) {
        var n = /\W/.test(e) ? new Function("obj", "var p=[],print=function(){p.push.apply(p,arguments);};with(obj){p.push('" + e.replace(/[\r\t\n]/g, " ").split("<%").join("	").replace(/((^|%>)[^\t]*)'/g, "$1\r").replace(/\t=(.*?)%>/g, "',$1,'").split("	").join("');").split("%>").join("p.push('").split("\r").join("\\'") + "');}return p.join('');") : b[e] = b[e] || u(document.getElementById(e).innerHTML);
        return t ? n(t) : n;
    }
    var a = this, f = {
        linear: function(e) {
