 ...
 */(function(e, t, n, r, i) {
    ...
    if ("backgroundSize" in s.style && !e.debugBGS) return;
    e.cssHooks.backgroundSize = {
        set: function(t, n) {
            var r = !e.data(t, "bgsImg"), i, s, o;
            alert("hej igen");
            e.data(t, "bgsValue", n);
            if (r) {
                u.push(t);
                e.refreshBackgroundDimensions(t, !0);
                s = e("<div>").css({
                    position: "absolute",
                    zIndex: -1,
                    top: 0,
    ...
    e.refreshBackgroundDimensions = function(t, n) {
        ...
        }, s = e.data(t, "bgsDim"), o = !s || i.width != s.width || i.height != s.height;
        e.data(t, "bgsDim", i);
        o && !n && e.refreshBackground(t);
    };
    e.refreshBackgroundImage = function(t, n) {
        var r = e.data(t, "bgsImg"), i = (o.exec(n || e.css(t, "backgroundImage")) || [])[1], s = r && r.src, u = i != s, a, f;
        if (u) {
    ...
    e.refreshBackground = function(t) {
        var n = e.data(t, "bgsValue"), i = e.data(t, "bgsDim"), s = e.data(t, "bgsImgDim"), o = e(e.data(t, "bgsImg")), u = e.data(t, "bgsPos"), a = e.data(t, "bgsConstrain"), f, l = i.width / i.height, c = s.width / s.height, h;
        if (n == "contain") if (c > l) {
