// CodeKit import directives
// *** Native JS Helpers
// @codekit-append "helpers/hide-address-bar.js"
// @codekit-append "helpers/ios-orientation-fix.js"
// *** Modernizr
// @codekit-append "libs/modernizr/modernizr.min.js"
/* **********************************************
     Begin hide-address-bar.js
********************************************** *//*! Normalized address bar hiding for iOS & Android (c) @scottjehl MIT License */(function(e) {
    var t = e.document;
...
(function(e) {
    ...
    function d(t) {
        c = t.accelerationIncludingGravity;
        a = Math.abs(c.x);
        f = Math.abs(c.y);
        l = Math.abs(c.z);
        (!e.orientation || e.orientation === 180) && (a > 7 || (l > 6 && f < 8 || l < 8 && f > 6) && a > 5) ? u && p() : u || h();
    }
    ...
    if (!r) return;
    e.addEventListener("orientationchange", h, !1);
    e.addEventListener("devicemotion", d, !1);
})(this);
