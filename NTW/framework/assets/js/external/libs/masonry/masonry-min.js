if (!$("html").hasClass("lt-ie8")) {
    ...
    (function(e, t) {
        ...
        function u(e) {
            function u(e) {
                ...
                var u = r(e);
                if (u.display === "none") return o();
                var a = {};
                a.width = e.offsetWidth;
                a.height = e.offsetHeight;
                var f = a.isBorderBox = !!t && !!u[t] && u[t] === "border-box";
                for (var l = 0, c = s.length; l < c; l++) {
                    var h = s[l], p = u[h], d = parseFloat(p);
                    a[h] = isNaN(d) ? 0 : d;
                }
                var v = a.paddingLeft + a.paddingRight, m = a.paddingTop + a.paddingBottom, g = a.marginLeft + a.marginRight, y = a.marginTop + a.marginBottom, b = a.borderLeftWidth + a.borderRightWidth, w = a.borderTopWidth + a.borderBottomWidth, E = f && n, S = i(u.width);
                S !== !1 && (a.width = S + (E ? 0 : v + b));
                var x = i(u.height);
                x !== !1 && (a.height = x + (E ? 0 : m + w));
        ...
        var n = document.defaultView, r = n && n.getComputedStyle ? function(e) {
            return n.getComputedStyle(e, null);
        } : function(e) {
            return e.currentStyle;
        }, s = [ "paddingLeft", "paddingRight", "paddingTop", "paddingBottom", "marginLeft", "marginRight", "marginTop", "marginBottom", "borderLeftWidth", "borderRightWidth", "borderTopWidth", "borderBottomWidth" ];
        typeof define == "function" && define.amd ? define([ "get-style-property/get-style-property" ], u) : e.getSize = u(e.getStyleProperty);
    })(window);
    (function(e) {
        "use strict";
    ...
    (function(e) {
        ...
        function s(n) {
            n.bind(t, "DOMContentLoaded", i);
            n.bind(t, "readystatechange", i);
            n.bind(e, "load", i);
            return r;
        }
        var t = e.document, n = [];
        ...
        if (typeof define == "function" && define.amd) {
            r.isReady = typeof requirejs == "function";
            define([ "eventie/eventie" ], s);
        } else e.docReady = s(e.eventie);
    })(this);
    (function() {
        "use strict";
        function e() {}
        ...
        t.addListener = function(t, r) {
            var i = this.getListenersAsObject(t), s = typeof r == "object", o;
            for (o in i) i.hasOwnProperty(o) && n(i[o], r) === -1 && i[o].push(s ? r : {
                listener: r,
                once: !1
            });
            return this;
        ...
        t.removeListener = function(t, r) {
            var i = this.getListenersAsObject(t), s, o;
        ...
        t.removeEvent = function(t) {
            ...
            if (n === "string") delete r[t]; else if (n === "object") for (i in r) r.hasOwnProperty(i) && t.test(i) && delete r[i]; else delete this._events;
            return this;
        };
        t.emitEvent = function(t, n) {
            ...
            for (o in r) if (r.hasOwnProperty(o)) {
                ...
                while (s--) {
                    ...
                    (u === this._getOnceReturnValue() || i.once === !0) && this.removeListener(t, i.listener);
                }
            }
            return this;
        };
        ...
        typeof define == "function" && define.amd ? define(function() {
            return e;
        }) : typeof module != "undefined" && module.exports ? module.exports = e : this.EventEmitter = e;
    }).call(this);
    (function(e) {
        "use strict";
        function n() {}
        ...
        typeof define == "function" && define.amd ? define([ "jquery" ], r) : r(e.jQuery);
    })(window);
    (function(e, t) {
        "use strict";
        function r(e, t) {
        ...
        if (n) {
            var a = document.createElement("div"), f = r(a, "div");
            u = f ? r : o;
        } else u = s;
        typeof define == "function" && define.amd ? define(function() {
            return u;
    ...
    (function(e) {
        ...
        function i(e, t, i) {
            ...
            var s = i("transition"), o = i("transform"), u = s && o, a = !!i("perspective"), f = {
                WebkitTransition: "webkitTransitionEnd",
                MozTransition: "transitionend",
                OTransition: "otransitionend",
                transition: "transitionend"
            }[s], l = [ "transform", "transition", "transitionDuration", "transitionProperty" ], c = function() {
                var e = {};
            ...
            h.prototype.getPosition = function() {
                var e = n(this.element), t = this.layout.options, r = t.isOriginLeft, i = t.isOriginTop, s = parseInt(e[r ? "left" : "right"], 10), o = parseInt(e[i ? "top" : "bottom"], 10);
                s = isNaN(s) ? 0 : s;
                o = isNaN(o) ? 0 : o;
                var u = this.layout.size;
                s -= r ? u.paddingLeft : u.paddingRight;
                o -= i ? u.paddingTop : u.paddingBottom;
                this.position.x = s;
                this.position.y = o;
            };
            h.prototype.layoutPosition = function() {
                ...
                if (t.isOriginLeft) {
                    n.left = this.position.x + e.paddingLeft + "px";
                    n.right = "";
                } else {
                    n.right = this.position.x + e.paddingRight + "px";
                    n.left = "";
                }
                if (t.isOriginTop) {
                    n.top = this.position.y + e.paddingTop + "px";
                    n.bottom = "";
                } else {
                    n.bottom = this.position.y + e.paddingBottom + "px";
                    n.top = "";
                }
                this.css(n);
            ...
            h.prototype.moveTo = u ? h.prototype._transitionTo : h.prototype.goTo;
            ...
            h.prototype._nonTransition = function(e) {
                ...
                e.onTransitionEnd && e.onTransitionEnd.call(this);
            };
            h.prototype._transition = function(e) {
                ...
                var s = {};
                s.transitionProperty = r.join(",");
                s.transitionDuration = t;
                this.element.addEventListener(f, this, !1);
                (e.isCleaning || e.onTransitionEnd) && this.on("transitionEnd", function(t) {
                    e.isCleaning && t._removeStyles(n);
                    e.onTransitionEnd && e.onTransitionEnd.call(t);
                    return !0;
                });
                if (e.from) {
                    this.css(e.from);
            ...
            h.prototype.transition = h.prototype[s ? "_transition" : "_nonTransition"];
            h.prototype.onwebkitTransitionEnd = function(e) {
        ...
        var t = document.defaultView, n = t && t.getComputedStyle ? function(e) {
            return t.getComputedStyle(e, null);
        } : function(e) {
            return e.currentStyle;
        };
        if (typeof define == "function" && define.amd) define([ "eventEmitter/EventEmitter", "get-size/get-size", "get-style-property/get-style-property" ], i); else {
            e.Outlayer = {};
            e.Outlayer.Item = i(e.EventEmitter, e.getSize, e.getStyleProperty);
        }
    })(window);
    (function(e) {
        "use strict";
        ...
        function a(e) {
            var t = [];
            if (u(e)) t = e; else if (e && typeof e.length == "number") for (var n = 0, r = e.length; n < r; n++) t.push(e[n]); else t.push(e);
            return t;
        }
        function c(e) {
        ...
        function h(o, u, h, p, d, v) {
            function y(e, r) {
                typeof e == "string" && (e = t.querySelector(e));
                if (!e || !f(e)) {
                    n && n.error("Bad " + this.settings.namespace + " element: " + e);
                    return;
                }
                this.element = e;
            ...
            s(y.prototype, h.prototype);
            y.prototype._create = function() {
                this.reloadItems();
                this.stamps = [];
                this.stamp(this.options.stamp);
                s(this.element.style, this.options.containerStyle);
            ...
            y.prototype._getItems = function(e) {
                var t = this._filterFindItemElements(e), n = this.settings.item, r = [];
                for (var i = 0, s = t.length; i < s; i++) {
                    var o = t[i], u = new n(o, this, this.options.itemOptions);
                    r.push(u);
                }
                return r;
            };
            y.prototype._filterFindItemElements = function(e) {
                e = a(e);
                var t = this.options.itemSelector, n = [];
            ...
            y.prototype._getMeasurement = function(e, t) {
                ...
                if (!n) this[e] = 0; else {
                    typeof n == "string" ? r = this.element.querySelector(n) : f(n) && (r = n);
                    this[e] = r ? p(r)[t] : n;
                }
            };
            ...
            y.prototype._getContainerSize = i;
            ...
            y.prototype.unstamp = function(e) {
                ...
                if (!e) return;
                for (var t = 0, n = e.length; t < n; t++) {
                    var r = e[t], i = l(this.stamps, r);
                    i !== -1 && this.stamps.splice(i, 1);
                    this.unignore(r);
                }
            };
            y.prototype._find = function(e) {
                if (!e) return;
                typeof e == "string" && (e = this.element.querySelectorAll(e));
                e = a(e);
                return e;
            };
            ...
            y.prototype.bindResize = function() {
                ...
                o.bind(e, "resize", this);
                this.isResizeBound = !0;
            };
            y.prototype.unbindResize = function() {
                o.unbind(e, "resize", this);
            ...
            y.prototype.resize = function() {
                ...
                if (t && e.innerWidth === this.size.innerWidth) return;
                this.layout();
            ...
            y.prototype.destroy = function() {
                ...
                r && r.removeData(this.element, this.settings.namespace);
            };
            y.data = function(e) {
            ...
            y.create = function(e, i) {
                ...
                s(o.prototype, y.prototype);
                b(o, "options");
                b(o, "settings");
                s(o.prototype.options, i);
                o.prototype.settings.namespace = e;
                o.data = y.data;
                o.Item = function() {
                    v.apply(this, arguments);
                };
                o.Item.prototype = new v;
                o.prototype.settings.item = o.Item;
                u(function() {
                    var i = c(e), s = t.querySelectorAll(".js-" + i), u = "data-" + i + "-options";
                    for (var a = 0, f = s.length; a < f; a++) {
                        var l = s[a], h = l.getAttribute(u), p;
                        try {
                            p = h && JSON.parse(h);
                        } catch (d) {
                ...
                r && r.bridget && r.bridget(e, o);
                return o;
            };
            y.Item = v;
            return y;
        }
        var t = e.document, n = e.console, r = e.jQuery, i = function() {}, o = Object.prototype.toString, f = typeof HTMLElement == "object" ? function(t) {
        ...
        typeof define == "function" && define.amd ? define([ "eventie/eventie", "doc-ready/doc-ready", "eventEmitter/EventEmitter", "get-size/get-size", "matches-selector/matches-selector", "./item" ], h) : e.Outlayer = h(e.eventie, e.docReady, e.EventEmitter, e.getSize, e.matchesSelector, e.Outlayer.Item);
    })(window);
    (function(e) {
        "use strict";
        function n(e, n) {
            ...
            r.prototype.measureColumns = function() {
                var e = this._getSizingContainer(), t = this.items[0], r = t && t.element;
                this.columnWidth || (this.columnWidth = r ? n(r).outerWidth : this.size.innerWidth);
                this.columnWidth += this.gutter;
                this._containerWidth = n(e).innerWidth;
            ...
            r.prototype._getItemLayoutPosition = function(e) {
                e.getSize();
                var n = Math.ceil(e.size.outerWidth / this.columnWidth);
                n = Math.min(n, this.cols);
                var r = this._getColGroup(n), i = Math.min.apply(Math, r), s = t(r, i), o = {
                    x: this.columnWidth * s,
                    y: i
                }, u = i + e.size.outerHeight, a = this.cols + 1 - r.length;
                for (var f = 0; f < a; f++) this.colYs[s + f] = u;
                return o;
            };
            r.prototype._getColGroup = function(e) {
                if (e === 1) return this.colYs;
            ...
            r.prototype._manageStamp = function(e) {
                var t = n(e), r = this._getElementOffset(e), i = this.options.isOriginLeft ? r.left : r.right, s = i + t.outerWidth, o = Math.floor(i / this.columnWidth);
                o = Math.max(0, o);
            ...
            r.prototype._getContainerSize = function() {
                ...
                this.options.isFitWidth && (e.width = this._getContainerFitWidth());
                return e;
            };
            ...
            r.prototype.resize = function() {
                var e = this._getSizingContainer(), t = n(e), r = this.size && t;
                if (r && t.innerWidth === this._containerWidth) return;
                this.layout();
                delete this.resizeTimeout;
            };
            return r;
        }
        var t = Array.prototype.indexOf ? function(e, t) {
            return e.indexOf(t);
        } : function(e, t) {
            for (var n = 0, r = e.length; n < r; n++) {
                var i = e[n];
        ...
        typeof define == "function" && define.amd ? define([ "outlayer/outlayer", "get-size/get-size" ], n) : e.Masonry = n(e.Outlayer, e.getSize);
    })(window);
};