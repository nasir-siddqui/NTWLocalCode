define(['jquery', 'angular', 'constants', 'helpers/common', 'local/queryStringHelper', 'translationPUI', 'translationManageUser', 'local/angularApplications/templates', 'local/angularApplications/services/corpAdministrationService', 'local/angularApplications/services/selectedRolesService', 'local/angularApplications/accessTree', 'local/angularApplications/combineRoles', 'angular-route', 'local/angularApplications/commonDirectives'],
    ...
    app.controller('ManageUserController', ['$scope', '$rootScope', '$q', '$location', 'corpAdministrationService', 'selectedRolesService', '$anchorScroll', '$route',
        function ($scope, $rootScope, $q, $location, corpAdministrationService, selectedRolesServiceWrapper, $anchorScroll, $route) {
        ...
        function saveUser() {
            ...
            corpAdministrationService.setRolesOnUser($scope.user.organizationTscid, $scope.user.tcwssUserId, $scope.currentRoleIds).then(function() {
            ...
            savedPromise.promise.then(navigateToListPage, handleError);
        }
