 ...
 *//*jslint evil: true, undef: true, browser: true *//*globals $, jQuery,define,_fnExternApiFunc,_fnInitialise,_fnInitComplete,_fnLanguageCompat,_fnAddColumn,_fnColumnOptions,_fnAddData,_fnCreateTr,_fnGatherData,_fnBuildHead,_fnDrawHead,_fnDraw,_fnReDraw,_fnAjaxUpdate,_fnAjaxParameters,_fnAjaxUpdateDraw,_fnServerParams,_fnAddOptionsHtml,_fnFeatureHtmlTable,_fnScrollDraw,_fnAdjustColumnSizing,_fnFeatureHtmlFilter,_fnFilterComplete,_fnFilterCustom,_fnFilterColumn,_fnFilter,_fnBuildSearchArray,_fnBuildSearchRow,_fnFilterCreateSearch,_fnDataToSearch,_fnSort,_fnSortAttachListener,_fnSortingClasses,_fnFeatureHtmlPaginate,_fnPageChange,_fnFeatureHtmlInfo,_fnUpdateInfo,_fnFeatureHtmlLength,_fnFeatureHtmlProcessing,_fnProcessingDisplay,_fnVisibleToColumnIndex,_fnColumnIndexToVisible,_fnNodeToDataIndex,_fnVisbleColumns,_fnCalculateEnd,_fnConvertToWidth,_fnCalculateColumnWidths,_fnScrollingWidthAdjust,_fnGetWidestNode,_fnGetMaxLenString,_fnStringToCss,_fnDetectType,_fnSettingsFromNode,_fnGetDataMaster,_fnGetTrNodes,_fnGetTdNodes,_fnEscapeRegex,_fnDeleteIndex,_fnReOrderIndex,_fnColumnOrdering,_fnLog,_fnClearTable,_fnSaveState,_fnLoadState,_fnCreateCookie,_fnReadCookie,_fnDetectHeader,_fnGetUniqueThs,_fnScrollBarWidth,_fnApplyToChildren,_fnMap,_fnGetRowData,_fnGetCellData,_fnSetCellData,_fnGetObjectDataFn,_fnSetObjectDataFn,_fnApplyColumnDefs,_fnBindAction,_fnCallbackReg,_fnCallbackFire,_fnJsonString,_fnRender,_fnNodeToColumnIndex,_fnInfoMacros,_fnBrowserDetect,_fnGetColumns*/(function(window, document, undefined) {
    (function(e) {
        "use strict";
        ...
        var DataTable = function(oInit) {
            function _fnAddColumn(e, t) {
                var n = DataTable.defaults.columns, r = e.aoColumns.length, i = $.extend({}, DataTable.models.oColumn, n, {
                ...
                if (e.aoPreSearchCols[r] === undefined || e.aoPreSearchCols[r] === null) e.aoPreSearchCols[r] = $.extend({}, DataTable.models.oSearch); else {
                    ...
                    s.bRegex === undefined && (s.bRegex = !0);
                    s.bSmart === undefined && (s.bSmart = !0);
                    s.bCaseInsensitive === undefined && (s.bCaseInsensitive = !0);
                }
            ...
            function _fnColumnOptions(e, t, n) {
                ...
                if (n !== undefined && n !== null) {
                    ...
                    if (n.sType !== undefined) {
                        r.sType = n.sType;
                        r._bAutoType = !1;
                    }
                    $.extend(r, n);
                    _fnMap(r, n, "sWidth", "sWidthOrig");
                    n.iDataSort !== undefined && (r.aDataSort = [ n.iDataSort ]);
                    _fnMap(r, n, "aDataSort");
                }
                ...
                r.fnSetData = _fnSetObjectDataFn(r.mData);
                e.oFeatures.bSort || (r.bSortable = !1);
                if (!r.bSortable || $.inArray("asc", r.asSorting) == -1 && $.inArray("desc", r.asSorting) == -1) {
                    r.sSortingClass = e.oClasses.sSortableNone;
                    r.sSortingClassJUI = "";
                } else if ($.inArray("asc", r.asSorting) == -1 && $.inArray("desc", r.asSorting) == -1) {
                    r.sSortingClass = e.oClasses.sSortable;
                    r.sSortingClassJUI = e.oClasses.sSortJUI;
                } else if ($.inArray("asc", r.asSorting) != -1 && $.inArray("desc", r.asSorting) == -1) {
                    r.sSortingClass = e.oClasses.sSortableAsc;
                    r.sSortingClassJUI = e.oClasses.sSortJUIAscAllowed;
                } else if ($.inArray("asc", r.asSorting) == -1 && $.inArray("desc", r.asSorting) != -1) {
                    r.sSortingClass = e.oClasses.sSortableDesc;
                    r.sSortingClassJUI = e.oClasses.sSortJUIDescAllowed;
                }
            }
            ...
            function _fnAddData(e, t) {
                ...
                for (var a = 0, f = e.aoColumns.length; a < f; a++) {
                    n = e.aoColumns[a];
                    typeof n.fnRender == "function" && n.bUseRendered && n.mData !== null ? _fnSetCellData(e, i, a, _fnRender(e, i, a)) : _fnSetCellData(e, i, a, _fnGetCellData(e, i, a));
                    if (n._bAutoType && n.sType != "string") {
                        var l = _fnGetCellData(e, i, a, "type");
                        if (l !== null && l !== "") {
                            u = _fnDetectType(l);
                            n.sType === null ? n.sType = u : n.sType != u && n.sType != "html" && (n.sType = "string");
                        }
                    }
                }
                e.aiDisplayMaster.push(i);
                e.oFeatures.bDeferRender || _fnCreateTr(e, i);
                return i;
            }
            function _fnGatherData(e) {
                ...
                if (e.bDeferLoading || e.sAjaxSource === null) {
                    ...
                    while (l) {
                        if (l.nodeName.toUpperCase() == "TR") {
                            h = e.aoData.length;
                            l._DT_RowIndex = h;
                            e.aoData.push($.extend(!0, {}, DataTable.models.oRow, {
                                nTr: l
                            }));
                            e.aiDisplayMaster.push(h);
                            f = l.firstChild;
                            o = 0;
                            while (f) {
                                g = f.nodeName.toUpperCase();
                                if (g == "TD" || g == "TH") {
                                    _fnSetCellData(e, h, o, $.trim(f.innerHTML));
                                    o++;
                                }
                                f = f.nextSibling;
                            }
                ...
                for (v = 0, m = e.aoColumns.length; v < m; v++) {
                    y = e.aoColumns[v];
                    y.sTitle === null && (y.sTitle = y.nTh.innerHTML);
                    var w = y._bAutoType, E = typeof y.fnRender == "function", S = y.sClass !== null, x = y.bVisible, T, N, C, k;
                    if (w || E || S || !x) for (p = 0, d = e.aoData.length; p < d; p++) {
                        b = e.aoData[p];
                        T = u[p * m + v];
                        if (w && y.sType != "string") {
                            k = _fnGetCellData(e, p, v, "type");
                            if (k !== "") {
                                N = _fnDetectType(k);
                                y.sType === null ? y.sType = N : y.sType != N && y.sType != "html" && (y.sType = "string");
                            }
                        }
                        y.mRender ? T.innerHTML = _fnGetCellData(e, p, v, "display") : y.mData !== v && (T.innerHTML = _fnGetCellData(e, p, v, "display"));
                        if (E) {
                            C = _fnRender(e, p, v);
                            T.innerHTML = C;
                            y.bUseRendered && _fnSetCellData(e, p, v, C);
                        }
                        S && (T.className += " " + y.sClass);
                        if (!x) {
                            b._anHidden[v] = T;
                            T.parentNode.removeChild(T);
                        } else b._anHidden[v] = null;
                        y.fnCreatedCell && y.fnCreatedCell.call(e.oInstance, T, _fnGetCellData(e, p, v, "display"), b._aData, p, v);
                    }
                }
                if (e.aoRowCreatedCallback.length !== 0) for (n = 0, r = e.aoData.length; n < r; n++) {
                    b = e.aoData[n];
                    _fnCallbackFire(e, "aoRowCreatedCallback", null, [ b.nTr, b._aData, n ]);
                }
            }
            ...
            function _fnGetCellData(e, t, n, r) {
                ...
                if ((i = s.fnGetData(o, r)) === undefined) {
                    if (e.iDrawError != e.iDraw && s.sDefaultContent === null) {
                        _fnLog(e, 0, "Requested unknown parameter " + (typeof s.mData == "function" ? "{mData function}" : "'" + s.mData + "'") + " from the data source for row " + t);
                        e.iDrawError = e.iDraw;
                    }
                    return s.sDefaultContent;
                }
            ...
            function _fnCreateTr(e, t) {
                var n = e.aoData[t], r;
                if (n.nTr === null) {
                    n.nTr = document.createElement("tr");
                    ...
                    for (var i = 0, s = e.aoColumns.length; i < s; i++) {
                        var o = e.aoColumns[i];
                        r = document.createElement(o.sCellType);
                        r.innerHTML = typeof o.fnRender != "function" || !!o.bUseRendered && o.mData !== null ? _fnGetCellData(e, t, i, "display") : _fnRender(e, t, i);
                        o.sClass !== null && (r.className = o.sClass);
                        if (o.bVisible) {
                            n.nTr.appendChild(r);
                            n._anHidden[i] = null;
                        } else n._anHidden[i] = r;
                        o.fnCreatedCell && o.fnCreatedCell.call(e.oInstance, r, _fnGetCellData(e, t, i, "display"), n._aData, t, i);
                    }
            ...
            function _fnBuildHead(e) {
                ...
                if (o !== 0) for (t = 0, r = e.aoColumns.length; t < r; t++) {
                    n = e.aoColumns[t].nTh;
                    n.setAttribute("role", "columnheader");
                    if (e.aoColumns[t].bSortable) {
                        n.setAttribute("tabindex", e.iTabIndex);
                        n.setAttribute("aria-controls", e.sTableId);
                    }
                    e.aoColumns[t].sClass !== null && $(n).addClass(e.aoColumns[t].sClass);
                    e.aoColumns[t].sTitle != n.innerHTML && (n.innerHTML = e.aoColumns[t].sTitle);
                } else {
                    var f = document.createElement("tr");
                    for (t = 0, r = e.aoColumns.length; t < r; t++) {
                        n = e.aoColumns[t].nTh;
                        n.innerHTML = e.aoColumns[t].sTitle;
                        n.setAttribute("tabindex", "0");
                        e.aoColumns[t].sClass !== null && $(n).addClass(e.aoColumns[t].sClass);
                        f.appendChild(n);
                    }
                    $(e.nTHead).html("")[0].appendChild(f);
                    _fnDetectHeader(e.aoHeader, e.nTHead);
                }
                $(e.nTHead).children("tr").attr("role", "row");
                if (e.bJUI) for (t = 0, r = e.aoColumns.length; t < r; t++) {
                    n = e.aoColumns[t].nTh;
                    var l = document.createElement("div");
                    l.className = e.oClasses.sSortJUIWrapper;
                    $(n).contents().appendTo(l);
                    var c = document.createElement("span");
                    c.className = e.oClasses.sSortIcon;
                    l.appendChild(c);
                    n.appendChild(l);
                }
                ...
                if (e.nTFoot !== null) {
                    ...
                    for (t = 0, r = e.aoColumns.length; t < r; t++) if (h[t]) {
                        e.aoColumns[t].nTf = h[t];
                        e.aoColumns[t].sClass && $(h[t]).addClass(e.aoColumns[t].sClass);
                    }
                }
            }
            function _fnDrawHead(e, t, n) {
                ...
                for (r = 0, i = c.length; r < i; r++) {
                    ...
                    for (s = 0, o = c[r].length; s < o; s++) {
                        ...
                        v = 1;
                        if (h[r][s] === undefined) {
                            l.appendChild(c[r][s].cell);
                            h[r][s] = 1;
                            while (c[r + d] !== undefined && c[r][s].cell == c[r + d][s].cell) {
                                h[r + d][s] = 1;
                                d++;
                            }
                            ...
                            c[r][s].cell.rowSpan = d;
                            c[r][s].cell.colSpan = v;
                        }
                    }
                }
            }
            function _fnDraw(e) {
                ...
                e.bDrawing = !0;
                if (e.iInitDisplayStart !== undefined && e.iInitDisplayStart != -1) {
                    e.oFeatures.bServerSide ? e._iDisplayStart = e.iInitDisplayStart : e._iDisplayStart = e.iInitDisplayStart >= e.fnRecordsDisplay() ? 0 : e.iInitDisplayStart;
                ...
                if (e.bDeferLoading) {
                    e.bDeferLoading = !1;
                    e.iDraw++;
                } else if (!e.oFeatures.bServerSide) e.iDraw++; else if (!e.bDestroying && !_fnAjaxUpdate(e)) return;
                if (e.aiDisplay.length !== 0) {
                    ...
                    for (var c = f; c < l; c++) {
                        ...
                        if (u !== 0) {
                            ...
                            if (h._sRowStripe != d) {
                                $(p).removeClass(h._sRowStripe).addClass(d);
                                h._sRowStripe = d;
                            }
                        }
                        _fnCallbackFire(e, "aoRowCallback", null, [ p, e.aoData[e.aiDisplay[c]]._aData, o, c ]);
                        s.push(p);
                        o++;
                    ...
                    s[0] = document.createElement("tr");
                    e.asStripeClasses[0] && (s[0].className = e.asStripeClasses[0]);
                    ...
                    y.colSpan = _fnVisbleColumns(e);
                    y.className = e.oClasses.sRowEmpty;
                    y.innerHTML = _fnInfoMacros(e, g);
                    s[o].appendChild(y);
                }
                _fnCallbackFire(e, "aoHeaderCallback", "header", [ $(e.nTHead).children("tr")[0], _fnGetDataMaster(e), e._iDisplayStart, e.fnDisplayEnd(), e.aiDisplay ]);
                _fnCallbackFire(e, "aoFooterCallback", "footer", [ $(e.nTFoot).children("tr")[0], _fnGetDataMaster(e), e._iDisplayStart, e.fnDisplayEnd(), e.aiDisplay ]);
                var b = document.createDocumentFragment(), w = document.createDocumentFragment(), E, S;
                if (e.nTBody) {
                    E = e.nTBody.parentNode;
                    w.appendChild(e.nTBody);
                    ...
                    e.nTBody.appendChild(b);
                    E !== null && E.appendChild(e.nTBody);
                }
                ...
                if (e.oFeatures.bServerSide) {
                    _fnProcessingDisplay(e, !1);
                    e._bInitComplete || _fnInitComplete(e);
                }
            }
            function _fnReDraw(e) {
                if (e.oFeatures.bSort) _fnSort(e, e.oPreviousSearch); else if (e.oFeatures.bFilter) _fnFilterComplete(e, e.oPreviousSearch); else {
                    _fnCalculateEnd(e);
                    _fnDraw(e);
                }
            }
            function _fnAddOptionsHtml(e) {
                ...
                e.nTableWrapper = $('<div id="' + e.sTableId + '_wrapper" class="' + e.oClasses.sWrapper + '" role="grid"></div>')[0];
                ...
                for (var c = 0; c < r.length; c++) {
                    ...
                    if (o == "<") {
                        ...
                        if (a == "'" || a == '"') {
                            ...
                            if (f.indexOf(".") != -1) {
                                var h = f.split(".");
                                u.id = h[0].substr(1, h[0].length - 1);
                                u.className = h[1];
                        ...
                        i = _fnFeatureHtmlLength(e);
                        s = 1;
                    } else if (o == "f" && e.oFeatures.bFilter) {
                        i = _fnFeatureHtmlFilter(e);
                        s = 1;
                    } else if (o == "r" && e.oFeatures.bProcessing) {
                        i = _fnFeatureHtmlProcessing(e);
                        s = 1;
                    } else if (o == "t") {
                        i = _fnFeatureHtmlTable(e);
                        s = 1;
                    } else if (o == "i" && e.oFeatures.bInfo) {
                        i = _fnFeatureHtmlInfo(e);
                        s = 1;
                    } else if (o == "p" && e.oFeatures.bPaginate) {
                        i = _fnFeatureHtmlPaginate(e);
                        s = 1;
                    ...
                    if (s == 1 && i !== null) {
                        typeof e.aanFeatures[o] != "object" && (e.aanFeatures[o] = []);
                        e.aanFeatures[o].push(i);
                        n.appendChild(i);
                    }
                }
                ...
                for (s = 0, a = n.length; s < a; s++) {
                    ...
                    while (i) {
                        if (i.nodeName.toUpperCase() == "TD" || i.nodeName.toUpperCase() == "TH") {
                            h = i.getAttribute("colspan") * 1;
                            p = i.getAttribute("rowspan") * 1;
                            h = !h || h === 0 || h === 1 ? 1 : h;
                            p = !p || p === 0 || p === 1 ? 1 : p;
                            l = v(e, s, c);
                            d = h === 1 ? !0 : !1;
                            for (u = 0; u < h; u++) for (o = 0; o < p; o++) {
                                e[s + o][l + u] = {
                                    cell: i,
                                    unique: d
                                };
            ...
            function _fnAjaxUpdate(e) {
                if (e.bAjaxDataGet) {
                    e.iDraw++;
                    _fnProcessingDisplay(e, !0);
                    var t = e.aoColumns.length, n = _fnAjaxParameters(e);
                    _fnServerParams(e, n);
                    e.fnServerData.call(e.oInstance, e.sAjaxSource, n, function(t) {
            ...
            function _fnAjaxUpdateDraw(e, t) {
                ...
                (!e.oScroll.bInfinite || e.oScroll.bInfinite && (e.bSorted || e.bFiltered)) && _fnClearTable(e);
            ...
            function _fnFeatureHtmlFilter(e) {
                ...
                r._DT_Input = i[0];
                i.val(t.sSearch.replace('"', "&quot;"));
                i.bind("keyup.DT", function(n) {
            ...
            function _fnFilter(e, t, n, r, i, s) {
                ...
                n || (n = 0);
                DataTable.ext.afnFiltering.length !== 0 && (n = 1);
                if (t.length <= 0) {
                    e.aiDisplay.splice(0, e.aiDisplay.length);
                    e.aiDisplay = e.aiDisplayMaster.slice();
                } else if (e.aiDisplay.length == e.aiDisplayMaster.length || a.sSearch.length > t.length || n == 1 || t.indexOf(a.sSearch) !== 0) {
                    e.aiDisplay.splice(0, e.aiDisplay.length);
                    _fnBuildSearchArray(e, 1);
                    for (o = 0; o < e.aiDisplayMaster.length; o++) u.test(e.asDataSearch[o]) && e.aiDisplay.push(e.aiDisplayMaster[o]);
                } else {
                    var f = 0;
                    for (o = 0; o < e.asDataSearch.length; o++) if (!u.test(e.asDataSearch[o])) {
                        e.aiDisplay.splice(o - f, 1);
                        f++;
                    }
                }
            }
            ...
            function _fnBuildSearchRow(e, t) {
                var n = t.join("  ");
                n.indexOf("&") !== -1 && (n = $("<div>").html(n).text());
                return n.replace(/[\n\r]/g, " ");
            }
            function _fnFilterCreateSearch(e, t, n, r) {
                var i, s;
                if (n) {
                    i = t ? e.split(" ") : _fnEscapeRegex(e).split(" ");
                    s = "^(?=.*?" + i.join(")(?=.*?") + ").*$";
                    return new RegExp(s, r ? "i" : "");
                }
            ...
            function _fnUpdateInfo(e) {
                ...
                s === 0 ? o = t.sInfoEmpty : o = t.sInfo;
                s != i && (o += " " + t.sInfoFiltered);
                o += t.sInfoPostFix;
                o = _fnInfoMacros(e, o);
                t.fnInfoCallback !== null && (o = t.fnInfoCallback.call(e.oInstance, e, n, r, i, s, o));
            ...
            function _fnInfoMacros(e, t) {
                ...
                e.oScroll.bInfinite && (r = e.fnFormatNumber(1));
                return t.replace(/_START_/g, r).replace(/_END_/g, s).replace(/_TOTAL_/g, u).replace(/_MAX_/g, f);
            }
            function _fnInitialise(e) {
                ...
                e.nTFoot && _fnDrawHead(e, e.aoFooter);
                _fnProcessingDisplay(e, !0);
                e.oFeatures.bAutoWidth && _fnCalculateColumnWidths(e);
                ...
                if (e.oFeatures.bSort) _fnSort(e); else if (e.oFeatures.bFilter) _fnFilterComplete(e, e.oPreviousSearch); else {
                    e.aiDisplay = e.aiDisplayMaster.slice();
                    _fnCalculateEnd(e);
                    _fnDraw(e);
                }
            ...
            function _fnLanguageCompat(e) {
                ...
                !e.sEmptyTable && e.sZeroRecords && t.sEmptyTable === "No data available in table" && _fnMap(e, e, "sZeroRecords", "sEmptyTable");
                !e.sLoadingRecords && e.sZeroRecords && t.sLoadingRecords === "Loading..." && _fnMap(e, e, "sZeroRecords", "sLoadingRecords");
            }
            function _fnFeatureHtmlLength(e) {
                ...
                e.aanFeatures.l || (o.id = e.sTableId + "_length");
                o.className = e.oClasses.sLength;
                o.innerHTML = "<label>" + e.oLanguage.sLengthMenu.replace("_MENU_", n) + "</label>";
                $('select option[value="' + e._iDisplayLength + '"]', o).attr("selected", !0);
                $("select", o).bind("change.DT", function(t) {
                    var n = $(this).val(), s = e.aanFeatures.l;
                    for (r = 0, i = s.length; r < i; r++) s[r] != this.parentNode && $("select", s[r]).val(n);
                    e._iDisplayLength = parseInt(n, 10);
                    _fnCalculateEnd(e);
                ...
                $("select", o).attr("aria-controls", e.sTableId);
                return o;
            }
            ...
            function _fnFeatureHtmlPaginate(e) {
                ...
                DataTable.ext.oPagination[e.sPaginationType].fnInit(e, t, function(e) {
                    _fnCalculateEnd(e);
                    _fnDraw(e);
                });
            ...
            function _fnPageChange(e, t) {
                ...
                if (typeof t == "number") {
                    e._iDisplayStart = t * e._iDisplayLength;
                    e._iDisplayStart > e.fnRecordsDisplay() && (e._iDisplayStart = 0);
                } else if (t == "first") e._iDisplayStart = 0; else if (t == "previous") {
                    e._iDisplayStart = e._iDisplayLength >= 0 ? e._iDisplayStart - e._iDisplayLength : 0;
                    e._iDisplayStart < 0 && (e._iDisplayStart = 0);
                } else if (t == "next") e._iDisplayLength >= 0 ? e._iDisplayStart + e._iDisplayLength < e.fnRecordsDisplay() && (e._iDisplayStart += e._iDisplayLength) : e._iDisplayStart = 0; else if (t == "last") if (e._iDisplayLength >= 0) {
            ...
            function _fnFeatureHtmlTable(e) {
                ...
                n.className = c.sScrollHead;
                r.className = c.sScrollHeadInner;
                i.className = c.sScrollBody;
                s.className = c.sScrollFoot;
                o.className = c.sScrollFootInner;
                if (e.oScroll.bAutoCss) {
                ...
                if (h.length > 0) {
                    h = h[0];
                    h._captionSide === "top" ? u.appendChild(h) : h._captionSide === "bottom" && l && a.appendChild(h);
                }
                if (e.oScroll.sX !== "") {
                    n.style.width = _fnStringToCss(e.oScroll.sX);
                    i.style.width = _fnStringToCss(e.oScroll.sX);
                    l !== null && (s.style.width = _fnStringToCss(e.oScroll.sX));
                    $(i).scroll(function(e) {
                        n.scrollLeft = this.scrollLeft;
                        l !== null && (s.scrollLeft = this.scrollLeft);
                    });
                }
                e.oScroll.sY !== "" && (i.style.height = _fnStringToCss(e.oScroll.sY));
                e.aoDrawCallback.push({
                    fn: _fnScrollDraw,
                    sName: "scrolling"
                });
                e.oScroll.bInfinite && $(i).scroll(function() {
                    if (!e.bDrawing && $(this).scrollTop() !== 0 && $(this).scrollTop() + $(this).height() > $(e.nTable).height() - e.oScroll.iLoadGap && e.fnDisplayEnd() < e.fnRecordsDisplay()) {
                        _fnPageChange(e, "next");
                        _fnCalculateEnd(e);
                        _fnDraw(e);
                    }
                });
            ...
            function _fnScrollDraw(e) {
                ...
                $(e.nTable).children("thead, tfoot").remove();
                d = $(e.nTHead).clone()[0];
                e.nTable.insertBefore(d, e.nTable.childNodes[0]);
                a = e.nTHead.getElementsByTagName("tr");
                f = d.getElementsByTagName("tr");
                if (e.nTFoot !== null) {
                    v = $(e.nTFoot).clone()[0];
                    e.nTable.insertBefore(v, e.nTable.childNodes[1]);
                    c = e.nTFoot.getElementsByTagName("tr");
                    l = v.getElementsByTagName("tr");
                }
                if (e.oScroll.sX === "") {
                    r.style.width = "100%";
                    t.parentNode.style.width = "100%";
                }
                var T = _fnGetUniqueThs(e, d);
                for (i = 0, s = T.length; i < s; i++) {
                    p = _fnVisibleToColumnIndex(e, i);
                    T[i].style.width = e.aoColumns[p].sWidth;
                }
                ...
                b = $(e.nTable).outerWidth();
                if (e.oScroll.sX === "") {
                    e.nTable.style.width = "100%";
                    S && ($("tbody", r).height() > r.offsetHeight || $(r).css("overflow-y") == "scroll") && (e.nTable.style.width = _fnStringToCss($(e.nTable).outerWidth() - e.oScroll.iBarWidth));
                } else if (e.oScroll.sXInner !== "") e.nTable.style.width = _fnStringToCss(e.oScroll.sXInner); else if (b == $(r).width() && $(r).height() < $(e.nTable).height()) {
                    e.nTable.style.width = _fnStringToCss(b - e.oScroll.iBarWidth);
                    $(e.nTable).outerWidth() > b - e.oScroll.iBarWidth && (e.nTable.style.width = _fnStringToCss(b));
                } else e.nTable.style.width = _fnStringToCss(b);
                b = $(e.nTable).outerWidth();
                _fnApplyToChildren(x, f);
                ...
                e.nTFoot !== null && _fnApplyToChildren(function(e, t) {
                    e.innerHTML = "";
                    e.style.width = y[t];
                }, l);
                if ($(e.nTable).outerWidth() < b) {
                    var N = r.scrollHeight > r.offsetHeight || $(r).css("overflow-y") == "scroll" ? b + e.oScroll.iBarWidth : b;
                    S && (r.scrollHeight > r.offsetHeight || $(r).css("overflow-y") == "scroll") && (e.nTable.style.width = _fnStringToCss(N - e.oScroll.iBarWidth));
                    r.style.width = _fnStringToCss(N);
                    e.nScrollHead.style.width = _fnStringToCss(N);
                    e.nTFoot !== null && (e.nScrollFoot.style.width = _fnStringToCss(N));
                    ...
                    r.style.width = _fnStringToCss("100%");
                    e.nScrollHead.style.width = _fnStringToCss("100%");
                    e.nTFoot !== null && (e.nScrollFoot.style.width = _fnStringToCss("100%"));
                }
                ...
                n.style.width = _fnStringToCss(k);
                t.style.width = _fnStringToCss(k);
                var L = $(e.nTable).height() > r.clientHeight || $(r).css("overflow-y") == "scroll";
                t.style.paddingRight = L ? e.oScroll.iBarWidth + "px" : "0px";
                if (e.nTFoot !== null) {
                    E.style.width = _fnStringToCss(k);
                    w.style.width = _fnStringToCss(k);
                    w.style.paddingRight = L ? e.oScroll.iBarWidth + "px" : "0px";
                }
                $(r).scroll();
            ...
            function _fnConvertToWidth(e, t) {
                ...
                r.style.width = _fnStringToCss(e);
                t.appendChild(r);
                n = r.offsetWidth;
                t.removeChild(r);
                return n;
            ...
            function _fnCalculateColumnWidths(e) {
                ...
                for (o = 0; o < s; o++) if (e.aoColumns[o].bVisible) {
                    i++;
                    if (e.aoColumns[o].sWidth !== null) {
                        r = _fnConvertToWidth(e.aoColumns[o].sWidthOrig, h);
                        r !== null && (e.aoColumns[o].sWidth = _fnStringToCss(r));
                        n++;
                    }
                }
                if (s == l.length && n === 0 && i == s && e.oScroll.sX === "" && e.oScroll.sY === "") for (o = 0; o < e.aoColumns.length; o++) {
                    r = $(l[o]).width();
                    r !== null && (e.aoColumns[o].sWidth = _fnStringToCss(r));
                } else {
                    ...
                    p.appendChild(d);
                    if (e.nTFoot !== null) {
                        p.appendChild(e.nTFoot.cloneNode(!0));
                        _fnApplyToChildren(function(e) {
                            e.style.width = "";
                    ...
                    for (o = 0; o < s; o++) if (e.aoColumns[o].bVisible) {
                        ...
                        if (E !== null) {
                            E = E.cloneNode(!0);
                            e.aoColumns[o].sContentPadding !== "" && (E.innerHTML += e.aoColumns[o].sContentPadding);
                            m.appendChild(E);
                        }
                    }
                    h.appendChild(p);
                    if (e.oScroll.sX !== "" && e.oScroll.sXInner !== "") p.style.width = _fnStringToCss(e.oScroll.sXInner); else if (e.oScroll.sX !== "") {
                        p.style.width = "";
                        $(p).width() < h.offsetWidth && (p.style.width = _fnStringToCss(h.offsetWidth));
                    } else e.oScroll.sY !== "" ? p.style.width = _fnStringToCss(h.offsetWidth) : c && (p.style.width = _fnStringToCss(c));
                    p.style.visibility = "hidden";
                    _fnScrollingWidthAdjust(e, p);
                    var S = $("tbody tr:eq(0)", p).children();
                    S.length === 0 && (S = _fnGetUniqueThs(e, $("thead", p)[0]));
                    if (e.oScroll.sX !== "") {
                        var x = 0;
                        a = 0;
                        for (o = 0; o < e.aoColumns.length; o++) if (e.aoColumns[o].bVisible) {
                            e.aoColumns[o].sWidthOrig === null ? x += $(S[a]).outerWidth() : x += parseInt(e.aoColumns[o].sWidth.replace("px", ""), 10) + ($(S[a]).outerWidth() - $(S[a]).width());
                            a++;
                        }
                        p.style.width = _fnStringToCss(x);
                        e.nTable.style.width = _fnStringToCss(x);
                    }
                    a = 0;
                    for (o = 0; o < e.aoColumns.length; o++) if (e.aoColumns[o].bVisible) {
                        f = $(S[a]).width();
                        f !== null && f > 0 && (e.aoColumns[o].sWidth = _fnStringToCss(f));
                        a++;
                    }
                    var T = $(p).css("width");
                    e.nTable.style.width = T.indexOf("%") !== -1 ? T : _fnStringToCss($(p).outerWidth());
            ...
            function _fnGetWidestNode(e, t) {
                ...
                if (e.aoData[n].nTr === null) {
                    ...
                    r.innerHTML = _fnGetCellData(e, n, t, "");
                    return r;
                }
            ...
            function _fnSort(e, t) {
                ...
                if (!e.oFeatures.bServerSide && (e.aaSorting.length !== 0 || e.aaSortingFixed !== null)) {
                    ...
                    for (n = 0, r = p.length; n < r; n++) for (i = 0; i < b; i++) {
                        ...
                        for (o = 0, u = E.length; o < u; o++) {
                            a = d[E[o]].sType;
                            w = h[(a ? a : "string") + "-pre"];
                            p[n]._aSortData[E[o]] = w ? w(_fnGetCellData(e, n, E[o], "sort")) : _fnGetCellData(e, n, E[o], "sort");
                        }
                    }
                    e.aiDisplayMaster.sort(function(e, t) {
                        ...
                        for (n = 0; n < b; n++) {
                            ...
                            for (r = 0, i = o.length; r < i; r++) {
                                u = d[o[r]].sType;
                                s = h[(u ? u : "string") + "-" + l[n][1]](p[e]._aSortData[o[r]], p[t]._aSortData[o[r]]);
                                if (s !== 0) return s;
                            }
                        }
                ...
                e.bSorted = !0;
                $(e.oInstance).trigger("sort", e);
                if (e.oFeatures.bFilter) _fnFilterComplete(e, e.oPreviousSearch, 1); else {
                    e.aiDisplay = e.aiDisplayMaster.slice();
                    e._iDisplayStart = 0;
                    _fnCalculateEnd(e);
                    _fnDraw(e);
                    ...
                    var i = function() {
                        ...
                        if (t.shiftKey) {
                            ...
                            for (var o = 0; o < e.aaSorting.length; o++) if (e.aaSorting[o][0] == n) {
                                ...
                                r = e.aaSorting[o][0];
                                i = e.aaSorting[o][2] + 1;
                                if (!e.aoColumns[r].asSorting[i]) e.aaSorting.splice(o, 1); else {
                        ...
                        } else if (e.aaSorting.length == 1 && e.aaSorting[0][0] == n) {
                            r = e.aaSorting[0][0];
                            i = e.aaSorting[0][2] + 1;
                            e.aoColumns[r].asSorting[i] || (i = 0);
                            e.aaSorting[0][1] = e.aoColumns[r].asSorting[i];
                            e.aaSorting[0][2] = i;
                        } else {
                            e.aaSorting.splice(0, e.aaSorting.length);
                            e.aaSorting.push([ n, e.aoColumns[n].asSorting[0], 0 ]);
                        }
                        _fnSort(e);
                    };
                    if (!e.oFeatures.bProcessing) i(); else {
                        _fnProcessingDisplay(e, !0);
                        setTimeout(function() {
                            i();
                            e.oFeatures.bServerSide || _fnProcessingDisplay(e, !1);
                        }, 0);
                    }
            ...
            function _fnSortingClasses(e) {
                ...
                for (t = 0; t < e.aoColumns.length; t++) if (e.aoColumns[t].bSortable) {
                    u = e.aoColumns[t].sSortingClass;
                    s = -1;
                    for (r = 0; r < o.length; r++) if (o[r][0] == t) {
                        u = o[r][1] == "asc" ? f.sSortAsc : f.sSortDesc;
                        s = r;
                        break;
                    }
                    ...
                    if (e.bJUI) {
                        ...
                        var c;
                        s == -1 ? c = e.aoColumns[t].sSortingClassJUI : o[s][1] == "asc" ? c = f.sSortJUIAsc : c = f.sSortJUIDesc;
                        l.addClass(c);
                    }
                ...
                if (e.oFeatures.bSort && e.oFeatures.bSortClasses) {
                    ...
                    for (t = 0, n = h.length; t < n; t++) {
                        ...
                        b = v[d];
                        g = y.replace(m, b);
                        g != y ? h[t].className = $.trim(g) : b.length > 0 && y.indexOf(b) == -1 && (h[t].className = y + " " + b);
                    }
                }
            }
            function _fnSaveState(e) {
                if (!e.oFeatures.bStateSave || e.bDestroying) return;
                var t, n, r = e.oScroll.bInfinite, i = {
                    iCreate: (new Date).getTime(),
                    iStart: r ? 0 : e._iDisplayStart,
                    iEnd: r ? e._iDisplayLength : e._iDisplayEnd,
                ...
                _fnCallbackFire(e, "aoStateSaveParams", "stateSaveParams", [ e, i ]);
                e.fnStateSave.call(e.oInstance, e, i);
            }
            function _fnLoadState(e, t) {
                ...
                $.extend(e.oPreviousSearch, n.oSearch);
                $.extend(!0, e.aoPreSearchCols, n.aoSearchCols);
                t.saved_aoColumns = [];
                for (var i = 0; i < n.abVisCols.length; i++) {
                    t.saved_aoColumns[i] = {};
                    t.saved_aoColumns[i].bVisible = n.abVisCols[i];
                }
            ...
            function _fnGetTdNodes(e, t) {
                ...
                for (o = h; o < p; o++) {
                    ...
                    if (l.nTr !== null) {
                        ...
                        r = 0;
                        for (a = 0, f = e.aoColumns.length; a < f; a++) if (e.aoColumns[a].bVisible) n.push(i[a - r]); else {
                            n.push(l._anHidden[a]);
                            r++;
                        }
                    }
                }
            ...
            function _fnMap(e, t, n, r) {
                r === undefined && (r = n);
                t[n] !== undefined && (e[r] = t[n]);
            }
            function _fnExtend(e, t) {
                var n;
                for (var r in t) if (t.hasOwnProperty(r)) {
                    n = t[r];
                    typeof oInit[r] == "object" && n !== null && $.isArray(n) === !1 ? $.extend(!0, e[r], n) : e[r] = n;
                }
                return e;
            }
            ...
            function _fnCallbackFire(e, t, n, r) {
                ...
                n !== null && $(e.oInstance).trigger(n, r);
                return s;
            }
            function _fnBrowserDetect(e) {
                ...
                e.oBrowser.bScrollOversize = $("#DT_BrowserTest", t)[0].offsetWidth === 100 ? !0 : !1;
            ...
            var __reArray = /\[.*?\]$/, _fnJsonString = window.JSON ? JSON.stringify : function(e) {
                ...
                for (n in e) {
                    r = e[n];
                    t = typeof r;
                    t === "string" ? r = '"' + r + '"' : t === "object" && r !== null && (r = _fnJsonString(r));
                    i.push((s ? "" : '"' + n + '":') + r);
                }
                return (s ? "[" : "{") + i + (s ? "]" : "}");
            };
            this.$ = function(e, t) {
                ...
                if (t.page == "current") for (n = o._iDisplayStart, r = o.fnDisplayEnd(); n < r; n++) {
                    s = u[a[n]].nTr;
                    s && i.push(s);
                } else if (t.order == "current" && t.filter == "none") for (n = 0, r = f.length; n < r; n++) {
                    s = u[f[n]].nTr;
                    s && i.push(s);
                } else if (t.order == "current" && t.filter == "applied") for (n = 0, r = a.length; n < r; n++) {
                    s = u[a[n]].nTr;
                    s && i.push(s);
                } else if (t.order == "original" && t.filter == "none") for (n = 0, r = u.length; n < r; n++) {
                    s = u[n].nTr;
                    s && i.push(s);
                } else if (t.order == "original" && t.filter == "applied") for (n = 0, r = u.length; n < r; n++) {
                    s = u[n].nTr;
                    $.inArray(n, a) !== -1 && s && i.push(s);
                } else _fnLog(o, 1, "Unknown selection options");
            ...
            this.fnDeleteRow = function(e, t, n) {
                ...
                r.asDataSearch.splice(a, 1);
                _fnDeleteIndex(r.aiDisplayMaster, o);
                _fnDeleteIndex(r.aiDisplay, o);
                typeof t == "function" && t.call(this, r, u);
                if (r._iDisplayStart >= r.fnRecordsDisplay()) {
                    r._iDisplayStart -= r._iDisplayLength;
                    r._iDisplayStart < 0 && (r._iDisplayStart = 0);
                }
                if (n === undefined || n) {
                    _fnCalculateEnd(r);
                    _fnDraw(r);
            ...
            this.fnDestroy = function(e) {
                ...
                $(t.nTableWrapper).find("*").andSelf().unbind(".DT");
                $("tbody>tr>td." + t.oClasses.sRowEmpty, t.nTable).parent().remove();
                if (t.nTable != t.nTHead.parentNode) {
                    $(t.nTable).children("thead").remove();
                    t.nTable.appendChild(t.nTHead);
                }
                if (t.nTFoot && t.nTable != t.nTFoot.parentNode) {
                    $(t.nTable).children("tfoot").remove();
                    t.nTable.appendChild(t.nTFoot);
                }
                t.nTable.parentNode.removeChild(t.nTable);
                $(t.nTableWrapper).remove();
                t.aaSorting = [];
                t.aaSortingFixed = [];
                _fnSortingClasses(t);
                $(_fnGetTrNodes(t)).removeClass(t.asStripeClasses.join(" "));
                $("th, td", t.nTHead).removeClass([ t.oClasses.sSortable, t.oClasses.sSortableAsc, t.oClasses.sSortableDesc, t.oClasses.sSortableNone ].join(" "));
                if (t.bJUI) {
                    $("th span." + t.oClasses.sSortIcon + ", td span." + t.oClasses.sSortIcon, t.nTHead).remove();
                    $("th, td", t.nTHead).each(function() {
                ...
                t.oFeatures.bAutoWidth === !0 && (t.nTable.style.width = _fnStringToCss(t.sDestroyWidth));
            ...
            this.fnGetData = function(e, t) {
                ...
                if (e !== undefined) {
                    ...
                    if (typeof e == "object") {
                        ...
                        if (i === "tr") r = _fnNodeToDataIndex(n, e); else if (i === "td") {
                            r = _fnNodeToDataIndex(n, e.parentNode);
                            t = _fnNodeToColumnIndex(n, r, e);
                        }
                    }
            ...
            this.fnOpen = function(e, t, n) {
                ...
                s.appendChild(o);
                o.className = n;
                o.colSpan = _fnVisbleColumns(r);
                typeof t == "string" ? o.innerHTML = t : $(o).html(t);
                var u = $("tr", r.nTBody);
                $.inArray(e, u) != -1 && $(s).insertAfter(e);
                r.aoOpenRows.push({
                    nTr: s,
                    nParent: e
                });
            ...
            this.fnSetColumnVis = function(e, t, n) {
                ...
                } else for (i = 0, s = u.length; i < s; i++) if (u[i].nTr !== null) {
                    a = _fnGetTdNodes(r, i)[e];
                    u[i]._anHidden[e] = a;
                    a.parentNode.removeChild(a);
                }
                o[e].bVisible = t;
                _fnDrawHead(r, r.aoHeader);
                r.nTFoot && _fnDrawHead(r, r.aoFooter);
            ...
            this.fnUpdate = function(e, t, n, r, i) {
                ...
                if ($.isArray(e) && n === undefined) {
                    ...
                    _fnSetCellData(s, f, n, e);
                    a = _fnGetCellData(s, f, n, "display");
                    var l = s.aoColumns[n];
                    if (l.fnRender !== null) {
                        a = _fnRender(s, f, n);
                        l.bUseRendered && _fnSetCellData(s, f, n, a);
                    }
                    s.aoData[f].nTr !== null && (_fnGetTdNodes(s, f)[n].innerHTML = a);
                }
                var c = $.inArray(f, s.aiDisplay);
                s.asDataSearch[c] = _fnBuildSearchRow(s, _fnGetRowData(s, f, "filter", _fnGetColumns(s, "bSearchable")));
                (i === undefined || i) && _fnAdjustColumnSizing(s);
                (r === undefined || r) && _fnReDraw(s);
                return 0;
            };
            ...
            this.each(function() {
                ...
                if (o === null || o === "") {
                    o = "DataTables_Table_" + DataTable.ext._oExternConfig.iNextUnique++;
                    this.id = o;
                }
                var f = $.extend(!0, {}, DataTable.models.oSettings, {
                    nTable: this,
                    oApi: _that.oApi,
                    oInit: oInit,
                ...
                DataTable.settings.push(f);
                f.oInstance = _that.length === 1 ? _that : $(this).dataTable();
                oInit || (oInit = {});
                oInit.oLanguage && _fnLanguageCompat(oInit.oLanguage);
                oInit = _fnExtend($.extend(!0, {}, DataTable.defaults), oInit);
                _fnMap(f.oFeatures, oInit, "bPaginate");
                _fnMap(f.oFeatures, oInit, "bLengthChange");
                _fnMap(f.oFeatures, oInit, "bFilter");
                _fnMap(f.oFeatures, oInit, "bSort");
                _fnMap(f.oFeatures, oInit, "bInfo");
                _fnMap(f.oFeatures, oInit, "bProcessing");
                _fnMap(f.oFeatures, oInit, "bAutoWidth");
                _fnMap(f.oFeatures, oInit, "bSortClasses");
                _fnMap(f.oFeatures, oInit, "bServerSide");
                _fnMap(f.oFeatures, oInit, "bDeferRender");
                _fnMap(f.oScroll, oInit, "sScrollX", "sX");
                _fnMap(f.oScroll, oInit, "sScrollXInner", "sXInner");
                _fnMap(f.oScroll, oInit, "sScrollY", "sY");
                _fnMap(f.oScroll, oInit, "bScrollCollapse", "bCollapse");
                _fnMap(f.oScroll, oInit, "bScrollInfinite", "bInfinite");
                _fnMap(f.oScroll, oInit, "iScrollLoadGap", "iLoadGap");
                _fnMap(f.oScroll, oInit, "bScrollAutoCss", "bAutoCss");
                _fnMap(f, oInit, "asStripeClasses");
                _fnMap(f, oInit, "asStripClasses", "asStripeClasses");
                _fnMap(f, oInit, "fnServerData");
                _fnMap(f, oInit, "fnFormatNumber");
                _fnMap(f, oInit, "sServerMethod");
                _fnMap(f, oInit, "aaSorting");
                _fnMap(f, oInit, "aaSortingFixed");
                _fnMap(f, oInit, "aLengthMenu");
                _fnMap(f, oInit, "sPaginationType");
                _fnMap(f, oInit, "sAjaxSource");
                _fnMap(f, oInit, "sAjaxDataProp");
                _fnMap(f, oInit, "iCookieDuration");
                _fnMap(f, oInit, "sCookiePrefix");
                _fnMap(f, oInit, "sDom");
                _fnMap(f, oInit, "bSortCellsTop");
                _fnMap(f, oInit, "iTabIndex");
                _fnMap(f, oInit, "oSearch", "oPreviousSearch");
                _fnMap(f, oInit, "aoSearchCols", "aoPreSearchCols");
                _fnMap(f, oInit, "iDisplayLength", "_iDisplayLength");
                _fnMap(f, oInit, "bJQueryUI", "bJUI");
                _fnMap(f, oInit, "fnCookieCallback");
                _fnMap(f, oInit, "fnStateLoad");
                _fnMap(f, oInit, "fnStateSave");
                _fnMap(f.oLanguage, oInit, "fnInfoCallback");
                _fnCallbackReg(f, "aoDrawCallback", oInit.fnDrawCallback, "user");
                _fnCallbackReg(f, "aoServerParams", oInit.fnServerParams, "user");
                _fnCallbackReg(f, "aoStateSaveParams", oInit.fnStateSaveParams, "user");
                _fnCallbackReg(f, "aoStateLoadParams", oInit.fnStateLoadParams, "user");
                _fnCallbackReg(f, "aoStateLoaded", oInit.fnStateLoaded, "user");
                _fnCallbackReg(f, "aoRowCallback", oInit.fnRowCallback, "user");
                _fnCallbackReg(f, "aoRowCreatedCallback", oInit.fnCreatedRow, "user");
                _fnCallbackReg(f, "aoHeaderCallback", oInit.fnHeaderCallback, "user");
                _fnCallbackReg(f, "aoFooterCallback", oInit.fnFooterCallback, "user");
                _fnCallbackReg(f, "aoInitComplete", oInit.fnInitComplete, "user");
                _fnCallbackReg(f, "aoPreDrawCallback", oInit.fnPreDrawCallback, "user");
                f.oFeatures.bServerSide && f.oFeatures.bSort && f.oFeatures.bSortClasses ? _fnCallbackReg(f, "aoDrawCallback", _fnSortingClasses, "server_side_sort_classes") : f.oFeatures.bDeferRender && _fnCallbackReg(f, "aoDrawCallback", _fnSortingClasses, "defer_sort_classes");
                if (oInit.bJQueryUI) {
                    $.extend(f.oClasses, DataTable.ext.oJUIClasses);
                    oInit.sDom === DataTable.defaults.sDom && DataTable.defaults.sDom === "lfrtip" && (f.sDom = '<"H"lfr>t<"F"ip>');
                } else $.extend(f.oClasses, DataTable.ext.oStdClasses);
                $(this).addClass(f.oClasses.sTable);
                if (f.oScroll.sX !== "" || f.oScroll.sY !== "") f.oScroll.iBarWidth = _fnScrollBarWidth();
                if (f.iInitDisplayStart === undefined) {
                    f.iInitDisplayStart = oInit.iDisplayStart;
                    f._iDisplayStart = oInit.iDisplayStart;
                }
                if (oInit.bStateSave) {
                    f.oFeatures.bStateSave = !0;
                    _fnLoadState(f, oInit);
                    _fnCallbackReg(f, "aoDrawCallback", _fnSaveState, "state_save");
                }
                if (oInit.iDeferLoading !== null) {
                    f.bDeferLoading = !0;
                    var l = $.isArray(oInit.iDeferLoading);
                    f._iRecordsDisplay = l ? oInit.iDeferLoading[0] : oInit.iDeferLoading;
                    f._iRecordsTotal = l ? oInit.iDeferLoading[1] : oInit.iDeferLoading;
                }
                oInit.aaData !== null && (a = !0);
                if (oInit.oLanguage.sUrl !== "") {
                    f.oLanguage.sUrl = oInit.oLanguage.sUrl;
                    $.getJSON(f.oLanguage.sUrl, null, function(e) {
                        _fnLanguageCompat(e);
                        $.extend(!0, f.oLanguage, oInit.oLanguage, e);
                        _fnInitialise(f);
                    });
                    u = !0;
                } else $.extend(!0, f.oLanguage, oInit.oLanguage);
                oInit.asStripeClasses === null && (f.asStripeClasses = [ f.oClasses.sStripeOdd, f.oClasses.sStripeEven ]);
                t = f.asStripeClasses.length;
                f.asDestroyStripes = [];
                if (t) {
                    var c = !1, h = $(this).children("tbody").children("tr:lt(" + t + ")");
                    for (e = 0; e < t; e++) if (h.hasClass(f.asStripeClasses[e])) {
                        c = !0;
                        f.asDestroyStripes.push(f.asStripeClasses[e]);
                    }
                    c && h.removeClass(f.asStripeClasses.join(" "));
                }
                var p = [], d, v = this.getElementsByTagName("thead");
                if (v.length !== 0) {
                    _fnDetectHeader(f.aoHeader, v[0]);
                    p = _fnGetUniqueThs(f);
                }
                ...
                for (e = 0, t = d.length; e < t; e++) {
                    if (oInit.saved_aoColumns !== undefined && oInit.saved_aoColumns.length == t) {
                        d[e] === null && (d[e] = {});
                        d[e].bVisible = oInit.saved_aoColumns[e].bVisible;
                    }
                    _fnAddColumn(f, p ? p[e] : null);
                }
                ...
                for (e = 0, t = f.aaSorting.length; e < t; e++) {
                    ...
                    f.aaSorting[e][2] === undefined && (f.aaSorting[e][2] = 0);
                    oInit.aaSorting === undefined && f.saved_aaSorting === undefined && (f.aaSorting[e][1] = m.asSorting[0]);
                ...
                if (w.length === 0 && g.length > 0 && (f.oScroll.sX !== "" || f.oScroll.sY !== "")) {
                    w = [ document.createElement("tfoot") ];
                    this.appendChild(w[0]);
                }
                if (w.length > 0) {
                    f.nTFoot = w[0];
                    _fnDetectHeader(f.aoFooter, f.nTFoot);
                }
        ...
        DataTable.fnTables = function(e) {
            var t = [];
            jQuery.each(DataTable.settings, function(n, r) {
        ...
        DataTable.defaults = {
            ...
            fnFormatNumber: function(e) {
                ...
                for (var s = 0; s < i; s++) {
                    s % 3 === 0 && s !== 0 && (r = this.oLanguage.sInfoThousands + r);
                    r = n[i - s - 1] + r;
                }
                return r;
            },
            ...
            two_button: {
                ...
                fnUpdate: function(e, t) {
                    ...
                    for (var s = 0, o = r.length; s < o; s++) {
                        i = r[s].firstChild;
                        if (i) {
                            i.className = e._iDisplayStart === 0 ? n.sPagePrevDisabled : n.sPagePrevEnabled;
                            i = i.nextSibling;
                            i.className = e.fnDisplayEnd() == e.fnRecordsDisplay() ? n.sPageNextDisabled : n.sPageNextEnabled;
                        }
                    }
                }
            },
            ...
            full_numbers: {
                ...
                fnUpdate: function(e, t) {
                    ...
                    for (f = 0, l = m.length; f < l; f++) {
                        ...
                        $("span:eq(0)", v).html(o).children("a").each(g);
                        h = v.getElementsByTagName("a");
                        p = [ h[0], h[1], h[h.length - 2], h[h.length - 1] ];
                        $(p).removeClass(c.sPageButton + " " + c.sPageButtonActive + " " + c.sPageButtonStaticDisabled);
                        $([ p[0], p[1] ]).addClass(s == 1 ? c.sPageButtonStaticDisabled : c.sPageButton);
                        $([ p[2], p[3] ]).addClass(i === 0 || s === i || e._iDisplayLength === -1 ? c.sPageButtonStaticDisabled : c.sPageButton);
                    }
                }
            }
        });
