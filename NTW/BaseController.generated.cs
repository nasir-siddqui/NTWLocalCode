...
namespace Telia.NTW.Web.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_BaseController : Telia.NTW.Web.Controllers.BaseController
    {
        public T4MVC_BaseController() : base(Dummy.Instance) { }

        [NonAction]
        partial void RedirectToActionOverride(T4MVC_System_Web_Mvc_RedirectToRouteResult callInfo, string action, string controller);

        [NonAction]
        public override System.Web.Mvc.RedirectToRouteResult RedirectToAction(string action, string controller)
        {
            ...
            RedirectToActionOverride(callInfo, action, controller);
            return callInfo;
        }
